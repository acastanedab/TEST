...
Yanbal.SFT.Web.Components.Dialog = function (opts) {
    this.init(opts);
};

Yanbal.SFT.Web.Components.Dialog.prototype = {
    idDivDialog: 'divDialogSFT_GMD',
    ...
    open: function () {
        if (this.divDialog && !this.isOpen()) {
            ...
            Yanbal.SFT.Web.Components.TextBox.Function.Configure(this.idDivDialog);
        }
    },
    moveToTop: function () {
        if (this.divDialog) {
    ...
    getAjaxContent: function (opts) {
        var me = this;
        var ajaxBuscar = new Yanbal.SFT.Web.Components.Ajax({
            action: opts.action,
            dataType: 'html',
            data: opts.data,
