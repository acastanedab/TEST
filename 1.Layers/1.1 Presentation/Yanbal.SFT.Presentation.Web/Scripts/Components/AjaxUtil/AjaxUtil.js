...
Yanbal.SFT.Web.Components.Ajax = function (opts) {
    this.init(opts);
};

Yanbal.SFT.Web.Components.Ajax.prototype = {
    ...
    init: function (opts) {
        ...
        if (opts) {
            ...
            this.processData = opts.processData == false ? opts.processData : true;//JLRR
            this.hasFile = opts.hasFile == true ? opts.hasFile : false;//JLRR
    ...
    submit: function (customParam) {
        ...
        this.ajaxRequest.done(function (data) {
            if (data != null && data.Error != null && data.Error.Code != 0) {
    ...
    implementLoading: function () {
        this.loading = new Yanbal.SFT.Web.Components.ProgressBar({ targetLoading: this.targetLoading });
    },
