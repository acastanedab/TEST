...
/// </remarks>
try {
    ns('Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.Create.Controller');
    Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.Create.Controller = function () {
        var base = this;
        base.Ini = function (opts) {
            ...
            base.Control.Validator = new Yanbal.SFT.Web.Components.Validator({
                form: 'frmCreateBusinessUnitConfiguration',
        ...
        base.Control = {
            Dialog: null,
            BtnLoad: function () { return $('#btnFileUploadCreate'); },
            FileUploadCompanyLogo: null,
            FileUploadReportLogo: null,
            AjaxCreateSuccessCustom: null,
            Container: null,
            ModelCreate: Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.Models.Create,
            ...
            ParametersRegistration: {
                TxtCulture: function () { return $('#slcCultureCreate'); },
                TxtTimeZone: function () { return $('#slcTimeZoneCreate'); },
                TxtDisplayFormReport: function () { return $('#slcDisplayFormReportCreate'); },
                TxtCompanyImage: function () { return $('#CompanyImageUploadCreate'); },
                TxtReportImage: function () { return $('#ReportImageUploadCreate'); },
                TxtRowsPerPage: function () { return $('#txtRowsPerPage').spinner({ min: 1, max: 255 }); },
                TxtCharactersMinimumGloss: function () { return $('#txtCharactersMinimumGlossCreate').spinner({ max: 100 }); },
                TxtVowelsMinimumGloss: function () { return $('#txtVowelsMinimumGlossCreate').spinner({ max: 100 }); },
                ChkAcquiringMainMenu: function () { return $('#chkAcquiringMainMenuCreate'); }
            }
        };
                    ...
                    base.Control.Message.Confirmation({
                        ...
                        onAccept: function () {
                            ...
                            data.append('businessUnitConfiguration', JSON.stringify({
                                BusinessUnitCode: base.Control.ModelCreate.BusinessUnitCode,
        ...
        base.Ajax = {
            AjaxSave: new Yanbal.SFT.Web.Components.Ajax({
                action: Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.Actions.RegisterBusinessUnitConfiguration,
                autoSubmit: false,
                hasFile: true,
                contentType: false,
                processData: false,
