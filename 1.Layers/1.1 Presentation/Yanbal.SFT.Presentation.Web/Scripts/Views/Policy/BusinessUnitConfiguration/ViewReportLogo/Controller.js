ns('Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.ViewReportLogo');
Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.ViewReportLogo.Controller = function () {
    var base = this;
    ...
    base.Ajax = {
        AjaxSearch: new Yanbal.SFT.Web.Components.Ajax({
            action: Yanbal.SFT.Presentation.Web.Policy.BusinessUnitConfiguration.Actions.ViewReportLogoImage,
            autoSubmit: false
        }),
    };
};