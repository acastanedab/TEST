...
/// </remarks>
ns('Yanbal.SFT.Presentation.Web.Policy.CombinationOrder.Edit.Controller');
Yanbal.SFT.Presentation.Web.Policy.CombinationOrder.Edit.Controller = function () {
    var base = this;
    ...
    base.Control = {
        ...
        Container: null,
        ModelEdit: Yanbal.SFT.Presentation.Web.Policy.CombinationOrder.Models.Edit,
                ...
                base.Control.Message.Confirmation({
                    ...
                    onAccept: function () {
                        base.Ajax.AjaxSave.data = {
                            OrderCodeCombination: base.Control.ModelEdit.OrderCodeCombination,
                            ParameterCode: base.Control.ModelEdit.CodeParameter,
        ...
        AjaxSaveSuccess: function (data) {
            switch (data) {
                case "1":
                    ...
                    break;
                case "3":
                    base.Control.Message.Warning({ message: Yanbal.SFT.Presentation.Web.Policy.CombinationOrder.Resources.LabelExistingParameterInCombination });
                    break;
                default:
    ...
    base.Ajax = {
        AjaxSave: new Yanbal.SFT.Web.Components.Ajax({
            action: Yanbal.SFT.Presentation.Web.Policy.CombinationOrder.Actions.ModifyCombinationOrder,
            autoSubmit: false,
