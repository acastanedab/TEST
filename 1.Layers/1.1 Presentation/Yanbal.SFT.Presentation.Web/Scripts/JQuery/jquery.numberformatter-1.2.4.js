/**
 * jquery.numberFormater - Formating/Parsing Numbers in jQuery
 * 
 * Written by
 ...
 * has 1 set of functions, Formating a number to text has it's own. Before things
 ...
 * 
 * parseNumber(numberString, options) - Takes a number as text that is Formated the same as the given
 * options then and returns it as a plain Number object.
 * 
 * To achieve the old way of combining parsing and Formating to keep say a input field always Formated
 ...
 * });
 *
 * The syntax for the Formating is:
 * 0 = Digit
...
(function(jQuery) {
    ...
    function formatCodes(locale, isFullLocale) {
        if (nfLocales.size() == 0)
         ...
         if (isFullLocale == false) {
             // Extract and convert to lower-case any language code from a real 'locale' Formated string, if not use as-is
         ...
         if (codesIndex) {
            var codes = nfLocaleFormating[codesIndex];
            if (codes) {
                dec = codes[0];
                group = codes[1];
            }
     ...
     * 
     * @param {Object}  options         The Formating options to use
    ...
    jQuery.fn.formatNumber = function(options, writeBack, giveReturnValue) {
        ...
        return this.each(function() {
            ...
            // set Formated string back, only if a success
//          if (returnString) {
                if (writeBack) {
                    if (jQuery(this).is(":input"))
...
//          return '';
    ...
    /**
     * Formats a Number object into a string, using the given Formating options
     * 
     * @param {Object} numberString
     * @param {Object} options
     */
