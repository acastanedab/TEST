...
;(function ($) {
	...
	$.colorpicker = new function() {
		this.regional = {
			'':	{
				ok:				'OK',
				cancel:         Yanbal.SFT.Presentation.Web.Shared.Resources.EtiquetaCancelarConfirmacion,
				none:           Yanbal.SFT.Presentation.Web.Shared.Resources.EtiquetaNinguno,
				button:			'Color',
				title:          Yanbal.SFT.Presentation.Web.Shared.Resources.EtiquetaElijaColor,
				transparent:    Yanbal.SFT.Presentation.Web.Shared.Resources.EtiquetaTransparente,
				hsvH:			'H',
				hsvS:			'S',
				hsvV:			'V',
				rgbR:			'R',
	...
	$.widget("vanderlee.colorpicker", {
		...
		_callback: function (callback, spaces) {
			...
			if (that.color.set) {
				data = {
					Formated: that._formatColor(that.options.colorFormat, that.color),
					colorPicker: that
				};
